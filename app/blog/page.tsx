...
export const metadata: Metadata = {
  title: {
    absolute:
      "AI Automation, Web Development & E-Commerce Blog | Avlys AI",
  },
  description:
    "Insights on AI automation, agentic AI, web development, e-commerce, landing page design, and enterprise AI agents. Practical guides for SMB founders and business operators.",
  keywords: [
    "AI automation blog",
  ...
  twitter: {
    ...
    title:
      "AI Automation, Web Development & E-Commerce Blog | Avlys AI",
    description:
      "Insights on AI automation, agentic AI, web development, e-commerce, landing page design, and enterprise AI agents.",
  },
};
  ...
  "@graph": [
    {
      ...
      "@id": `${blogUrl}#webpage`,
      url: blogUrl,
      name: "AI Automation, Web Development & E-Commerce Blog - Avlys AI",
      description:
        "Insights on AI automation, agentic AI, web development, e-commerce, landing page design, and enterprise AI agents.",
      isPartOf: {
        ...
        <div className="mx-auto w-full max-w-6xl">
          <div className="max-w-4xl">
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-[var(--muted)]">
              Practical guides on AI automation, web development,
              e-commerce, and building software that grows your business.
            </p>
          </div>
            ...
            {blogPosts.map((post, index) => (
              ...
              >
                ...
                <div className="mt-6 border-t border-[var(--border-subtle)] pt-5">
                  <p className="font-mono text-xs uppercase tracking-[0.18em] text-[var(--muted-strong)] transition-opacity group-hover:opacity-70">
                    Read article →
                  </p>
                </div>
              </Link>
